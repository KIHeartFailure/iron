...
tab1 <- tab1 %>%
  mutate(
    ...
    footnote4 = if_else(var_tmp %in% c(modvars_tf, "shf_indexyear"), footnote_marker_symbol(4), ""),
...
footnote(
  ...
  symbol = c(
    ...
    "Source: NPR",
    "Source: SCB",
    "Included in the multiple imputation model (althought not necessarily imputed if there is no missing data) and logistic models",
